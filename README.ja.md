...
- **サンプル形式の自動変換**：リアルタイムコールバックの外側で、Float32、PCM16、PCM24、PCM32 を ASIO ドライバーが要求する標準形式へ変換します。
...
- 標準 ASIO 形式の `Float32LSB`、`Int16LSB`、`Int24LSB`、`Int32LSB` 間は自動変換します。packed valid-bit などの特殊な ASIO 形式には対応しません。
